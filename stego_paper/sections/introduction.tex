...
\begin{itemize}
    ...
    \item An artifact-based paired benchmark against the official zero-shot generative linguistic steganography baseline, including capacity, perplexity, lexical quality, length, decode success, and post-clustered comparisons.
\end{itemize}
