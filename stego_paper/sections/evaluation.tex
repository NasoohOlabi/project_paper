...
Imperceptibility is evaluated through the dual lenses of semantic coherence and contextual integration. Unlike traditional steganographic methodologies that risk producing disjointed or statistically anomalous text, our intent-based approach ensures that every stego-contribution maintains a clear thematic alignment with the encompassing discourse. Comparative analysis using MAUVE, a distributional similarity metric for generated text \cite{pillutla2021mauve}, Jensen--Shannon divergence (JSD), and cross-entropy (perplexity) assessments demonstrates that our generative framework preserves high levels of naturalness. This is particularly significant given that standard perplexity scores may not fully capture the nuances of long-context semantic quality \cite{wang2022perplexity}.
...
\begin{landscape}
	...
	\begin{longtable}{@{}p{2.05cm}p{2.35cm}cp{1.85cm}p{5.35cm}p{1.45cm}p{1.55cm}p{1.95cm}@{}}
		...
		\bottomrule
		\endlastfoot
		This work & Shared LLM (\texttt{temperature=0} for decode); GPT-2 for PPL & --- & Reddit threads; 571 stego strings & PPL $\approx 92.3$; KL $4.14$--$6.88$; JSD $\approx 0.54$ (word unigrams vs.\ matched post / global corpus) & explicit & social thread & text + semantic tangents \\
		\midrule
