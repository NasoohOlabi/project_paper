...
To close this gap, the remainder of this section synthesizes findings from a systematic review of 31 primary studies on LLM-based linguistic steganography published between 2018 and 2025, organized around the state of the published literature, its application domains, its evaluation practices, its patterns of external-knowledge integration, and its recurring limitations and trade-offs. Table~\ref{tab:survey_comparison} summarizes how this synthesis differs from the three prior surveys discussed above.
...
\begin{table}[t]
  ...
  \begin{tabularx}{\textwidth}{@{}p{2.5cm} p{1.6cm} X X X X@{}}
    ...
    This synthesis & 2018--2025 & Systematic & Text-only (LLM-based) & Yes & Yes \\
    \hline
  \end{tabularx}
\end{table}
...
\begin{table}[t]
  ...
  \begin{tabular}{p{0.18\textwidth}p{0.16\textwidth}p{0.22\textwidth}p{0.35\textwidth}}
    ...
    Zero-shot & 24 bits per four Base64 characters & Encoded secret representation & Capacity depends on the representation and prompt protocol. \\
